...
def parquet_module(parquet_module_path, tensor_schema, max_len, batch_size=16):
    ...
    # shared_meta.update(
    #     {
    #         "item_id": {"shape": 7, "padding": tensor_schema["item_id"].padding_value},
    #         "cat_list_feature": {"shape": (7,3), "padding": tensor_schema["cat_list_feature"].padding_value},
    #         # "num_feature": {"shape": 7, "padding": tensor_schema["num_feature"].padding_value},
    #         # "num_list_feature": {"shape": (7,5), "padding": tensor_schema["num_list_feature"].padding_value},
